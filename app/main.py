...
from modelos.cotizador import Cotizador
...
def solicitar_datos_cliente():
    ...
    cliente = Cliente(nombre, direccion, telefono, correo, datetime.now().strftime("%d-%m-%Y"))
    return cliente
...
def main():
    ...
    while True:
        ...
        if opcion == '1':
            ...
            ver_resumen(cliente, lista_ventanas, costo_total)
